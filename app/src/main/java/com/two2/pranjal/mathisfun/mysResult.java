...
/**
 * Created by pranjal on 5/31/15.
 */
public class mysResult extends BaseGameActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mysresult);
        tots=getIntent().getExtras().getInt("correctmys");
    ...
    public void onSignInFailed() {
        k=0;
        //ImageButton achievements= (ImageButton)findViewById(R.id.imageButton3);
    ...
    public void onClick2(View view){
        if(k==0)
        {
            Toast.makeText(mysResult.this, "User Not Signed-IN", Toast.LENGTH_LONG).show();
        }
        else {
