 ...
 */
public class mulResult extends BaseGameActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tots=getIntent().getExtras().getInt("correctmul");
    ...
    public void onClick2(View view){
        if(k==0)
        {
            Toast.makeText(mulResult.this, "User Not Signed-IN", Toast.LENGTH_LONG).show();
        }
        else {
