 ...
 */
public class div extends FragmentActivity {
    int numb=100;
    int checker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(checker==1)
        {
            ...
            play.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent start = new Intent(div.this, divIndex.class);
                    start.putExtra("divlevel", numb);
        ...
        else
        {
            ...
            play.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent start = new Intent(div.this, div2.class);
                    start.putExtra("divlevel", numb);
                    start.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    start.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(start);
