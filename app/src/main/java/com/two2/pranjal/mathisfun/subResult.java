 ...
 */
public class subResult extends BaseGameActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tots=getIntent().getExtras().getInt("correctsub");
    ...
    public void onClick2(View view){
        if(k==0)
        {
            Toast.makeText(subResult.this, "User Not Signed-IN", Toast.LENGTH_LONG).show();
        }
        else {
