 ...
 */
public class divResult extends BaseGameActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.divresult);
        tots=getIntent().getExtras().getInt("correctdiv");
    ...
    public void onClick2(View view){
        if(k==0)
        {
            Toast.makeText(divResult.this, "User Not Signed-IN", Toast.LENGTH_LONG).show();
        }
        else {
